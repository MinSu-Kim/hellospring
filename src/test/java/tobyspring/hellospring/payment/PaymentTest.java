...
public class PaymentTest {
    ...
    void createPrepared(){
        ...
        Payment payment = Payment.createPrepared(1L, "USD", BigDecimal.TEN, valueOf(1000), LocalDateTime.now(clock));

        Assertions.assertThat(payment.getConvertedAmount()).isEqualByComparingTo(valueOf(10_000));
        Assertions.assertThat(payment.getValidUntil().isEqual(LocalDateTime.now(clock).minusMinutes(30)));
    }
